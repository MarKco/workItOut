...
// You can define custom font families if you have them in res/font
// For example:
...
// Default Material 3 Typography definition
// These values are based on the Material 3 type scale.
...
val Typography = Typography(
    ...
    headlineLarge = TextStyle(
        fontFamily = FontFamily.Default,
        fontWeight = FontWeight.Normal, // M3 often uses Normal for headlines
        fontSize = 32.sp,
        lineHeight = 40.sp,
        letterSpacing = 0.sp
    ),
    ...
    titleLarge = TextStyle(
        fontFamily = FontFamily.Default,
        fontWeight = FontWeight.Medium, // Titles can be slightly bolder
        fontSize = 22.sp,
        lineHeight = 28.sp,
        letterSpacing = 0.sp
    ),
